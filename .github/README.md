...
[`@aws-sdk/client-kinesis`](https://www.npmjs.com/package/@aws-sdk/client-kinesis/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XScTezmXtKT/6SDyYnRnz6we34UCu/tFmrOz30Dgx1gr7C8SfDB07udb3yqpx1BF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis@3.6.0/index.min.mjs": "sha384-XScTezmXtKT/6SDyYnRnz6we34UCu/tFmrOz30Dgx1gr7C8SfDB07udb3yqpx1BF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis/blob/refs/tags/3.6.0/LICENSE
```
